variable "enabled" {
  description = "Create persistent r2 resources only after the Phase 02 owner gate."
  type        = bool
  default     = false
}
...
variable "bucket_names" {
  type    = set(string)
  default = ["definitions", "assets-quarantine", "assets-approved", "simulation", "analytics", "audit"]
}
