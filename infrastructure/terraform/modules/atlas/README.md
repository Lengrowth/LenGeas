...
Environment-isolated MongoDB Atlas and PrivateLink contract.
...
Atlas is private-only: the intended AWS PrivateLink path is the sole approved
ECS-to-Atlas route, and public Atlas access is a mandatory negative test.
