...
- The review candidate uses intentional two-commit evidence semantics: source-document commit `31235eaa904c1cd45102e7c35fe702cbb5a10565` remains the manifest `final_commit`, while candidate head `085188763455f147b54cb891bb53f30afddc29cd` contains the evidence-only regeneration. The evidence-only commit must not be treated as a new source implementation commit.
