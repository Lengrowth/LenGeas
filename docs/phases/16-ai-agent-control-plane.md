...
- [ ] **P16-T07 — Studio review.** Show model/version, brief, scopes, tool trace, cost, definition diff, validation, simulations, citations, risks, comments, human edits, submission, and independent approvals. Revoking a run prevents future tool calls. Depends on P16-T03–T06.
